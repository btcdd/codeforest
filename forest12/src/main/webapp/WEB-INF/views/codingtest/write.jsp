...
<link href="${pageContext.servletContext.contextPath }/assets/css/codingtest/write.css" rel="stylesheet" type="text/css">
		...
		<div class="regist">
			...
			<div class="codingtest-div">
				<div class="privateAndPassword">
					<div class="private">
						<input class="codingtest" type="checkbox" checked="checked" disabled>새 코딩 테스트 만들기
					</div>
				</div>
			</div>
