...
var fetchList = function() {
	...
	if(map.list.length == 0) {
		str = '<div class="nothing-save-problem"><div><i class="fas fa-hourglass-half fa-rotate-180" style="margin-right: 0.5em"></i><span>저장된 문제가 존재하지 않습니다</span></div><div class="move-to-training"><a class="training-start" href="${pageContext.servletContext.contextPath }/training">문제 저장하러 가기</a></div></div>';
